...
## Purpose
Branches is a mind-map style multi-branching AI chat application for the web. It solves the problem of linear chat logs becoming hard to review when chats drift by letting users split off-topic ideas into separate branches, keep the main discussion clean, and still visualize the overall structure through a tree-style UI and minimap.
